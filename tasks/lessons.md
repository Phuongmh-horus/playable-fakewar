...
- For a WebGL-only visual regression, verify that the final content asset and the build's runtime initialization path both carry the enablement data; an Editor scene preview alone does not prove a generated playable instance will receive it.
