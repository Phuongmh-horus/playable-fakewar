...
namespace PlayerArmy
{
    ...
    public class PlayerArmySystem : MonoBehaviour, IAttacker
    {
        ...
        [SerializeField, Min(0.05f)] private float projectileDuration = 0.5f;
        ...
        private const int MaxVisualUpgradesPerFrame = 2;
        ...
        private void RefreshLevelDamageBonus()
        {
            int damagePerLevel = Mathf.CeilToInt(_baseAttackDamage * (damageBonusPerUpgrade / 100f));
            _levelDamageBonus = _currentLevelIndex * damagePerLevel;
        }
        ...
        private void CacheDefaultState()
        {
            ...
            _baseAttackDamage = Mathf.Max(1, _baseAttackDamage);
