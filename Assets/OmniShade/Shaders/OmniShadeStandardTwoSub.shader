...
Shader "OmniShade/StandardTwoSub" { 
	Properties {
		...
		[Enum(Texture, 0, Alpha Main, 1)] _RimMaskMode ("Rim Mask mode", Float) = 0
		...
		_MatCapMaskTex ("MatCap Mask", 2D) = "white" {}
		[Enum(Texture, 0, Alpha Main, 1)] _MatCapMaskMode ("MatCap Mask mode", Float) = 0
    ...
    Subshader {
        ...
        Pass {
            ...
            #include "OmniShadeCoreTwoSub.cginc"
            #pragma target 3.5
            #pragma vertex vert
