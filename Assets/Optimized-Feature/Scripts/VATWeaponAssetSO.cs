...
{
    /// <summary>
    /// VAT payload for an optional renderer that shares the body frame manifest.
    /// A weapon asset has its own mesh, bounds, materials and position texture,
    /// while StartFrame/EndFrame values remain aligned with the body asset.
    /// </summary>
    [CreateAssetMenu(fileName = "VATWeaponAsset", menuName = "VAT/VAT Weapon Asset")]
