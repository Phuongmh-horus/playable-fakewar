...
> **Trạng thái tài liệu:** đây là kế hoạch lịch sử của giai đoạn redesign. Cấu trúc source hiện tại đã được tổ chức thành `Runtime/` và `Editor/` với hai assembly `OptimizedFeature.Runtime` và `OptimizedFeature.Editor`. Source of truth cho ranh giới module và cách tháo feature là [README](../../README.md); không xem các file `[NEW]` trong kế hoạch này là file bắt buộc đang tồn tại.
...
#### [NEW] [`VATStateMachineDataSO.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Runtime/Animation/VATStateMachineDataSO.cs)
...
#### [NEW] [`VATStateMachine.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Runtime/Animation/VATStateMachine.cs)
...
#### [MODIFY] [`VATAssetDataSO.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Runtime/Assets/VATAssetDataSO.cs)
...
#### [MODIFY] [`VAT_RenderComponent.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Runtime/Rendering/VAT_RenderComponent.cs)
...
#### [NEW] [`VATStateMachineImporter.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Editor/VATAnimatorGraph/VATStateMachineImporter.cs)
...
#### [NEW] [`VATBaker.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Editor/Baking/VATBaker.cs)
...
namespace OptimizedFeature.Scripts.Editor
{
    public static class VATBaker
    {
            ...
            bool overrideMode)
        {
            ...
            // - Pass 2: sample ghi texture pixels
...
#### [MODIFY] [`VATBakeToolWindow.cs`](file:///C:/UnityProjects/PLA_RPG_Game/Assets/Optimized-Feature/Editor/Baking/VATBakeToolWindow.cs)
